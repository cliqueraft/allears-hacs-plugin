...
@pytest.mark.asyncio
async def test_end_to_end_automation_trigger(hass: HomeAssistant, setup_integration: MockConfigEntry) -> None:
    ...
    assert await async_setup_component(hass, "input_boolean", {"input_boolean": {"test_success": {}}})
    ...
    coordinator: AllEarsDataUpdateCoordinator = hass.data[DOMAIN][setup_integration.entry_id]
    payload = {
        "app": "AllEars",
    ...
    print("SUCCESS: The automation successfully caught the 'Speech test' flow and executed its action!")
